...
namespace TinhTienDien
{
    class Program
    {
        ...
        static void Main()
        {
            ...
            if (sokWh > Muc2) sotien += (sokWh - Muc2) * Gia3 + 50 * Gia2 + 100 * Gia1;
            else if (sokWh > Muc1) sotien += (sokWh - Muc1) * Gia2 + 100 * Gia1;
            else sotien += sokWh * Gia1;   
            if (sokWh > Muc3) sotien += 0.1 * sotien;
            // Output
            Console.WriteLine("So tien: {0:F6}",sotien);
            Console.ReadKey();
        }
    }
}
